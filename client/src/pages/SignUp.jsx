...
export default function SignUp() {
  return (
    <div className="bg-gray-100 rounded-lg mt-20 flex container mx-auto gap-x-16">
        {/* left side */}
        <div className="flex-1 flex flex-col gap-y-5 p-8">
            <div>
            ...
            <div className="mt-4">
                ...
                <p className="text-gray-600 mt-2">Already have an account? <a href="/sign-in" className="text-blue-500 ml-1 hover:underline">Sign In</a></p>
            </div>
        </div>
